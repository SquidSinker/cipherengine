...
(PMatrix, cracked, fitnesses, divergences) = debug_linear_reinforcement(S, txt, 50, 2000, uniform_choice_weights, bibigramlog_arr, bigram_freq_vec, 25.0; lineage_habit = "floored ascent")
